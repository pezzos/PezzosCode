...
- A feature is considered ticketed if it contains `TASK-XXX.md`.
...
6) Copy `docs/04-process/ticket-template.md` into the feature folder as `TASK-XXX.md`.
