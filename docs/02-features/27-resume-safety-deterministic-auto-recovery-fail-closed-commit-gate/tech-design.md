# Technical Design: Resume safety + deterministic auto-recovery + fail-closed commit gate
...
- Implement `Resume safety + deterministic auto-recovery + fail-closed commit gate` in line with PRD priority `P0`.
...
- Feature artifacts: `docs/02-features/27-resume-safety-deterministic-auto-recovery-fail-closed-commit-gate`
