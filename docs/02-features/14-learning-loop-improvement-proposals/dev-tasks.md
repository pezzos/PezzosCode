...
- [x] **Task 1 - Define proposal trigger contract**
...
- [x] **Task 2 - Implement proposal writer**
...
- [x] **Task 3 - Implement dedup and status defaults**
...
- Offload ids (if any): `ff9c86967ecbbfbf1bb40c4e8a46c26f827915ea006b5f29442c8d4882fb6a69`; `ac99c0a449fd2a8e3f0b674161588cf0aa97b63864d4da04557b5a642ebb5ea6`; `921b6b8f0ebdc69445392ece45834ccba745fcccec8be58bf2fa9426a1448332`
- Docs/logs updated: `docs/02-features/14-learning-loop-improvement-proposals/*`, `docs/03-logs/implementation-log.md`, `docs/03-logs/validation-log.md`, `docs/possible-improvements.md`, `tools/pc-feature`, `lib/pc_runner.py`, `tests/test_pc_feature.py`
