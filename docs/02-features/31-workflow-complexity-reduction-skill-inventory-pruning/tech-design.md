# Technical Design: Workflow complexity reduction + skill inventory pruning
...
- Implement `Workflow complexity reduction + skill inventory pruning` in line with PRD priority `P1`.
...
- Feature artifacts: `docs/02-features/31-workflow-complexity-reduction-skill-inventory-pruning`
