# Test Plan: Output offload + token budget guardrails + structured logs + shared runner
...
- Validate `Output offload + token budget guardrails + structured logs + shared runner` acceptance criteria.
...
- Core behavior for `Output offload + token budget guardrails + structured logs + shared runner`
