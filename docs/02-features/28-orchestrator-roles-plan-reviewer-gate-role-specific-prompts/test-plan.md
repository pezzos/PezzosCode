# Test Plan: Orchestrator roles + Plan Reviewer gate + role-specific prompts
...
- Validate `Orchestrator roles + Plan Reviewer gate + role-specific prompts` acceptance criteria.
...
- Core behavior for `Orchestrator roles + Plan Reviewer gate + role-specific prompts`
