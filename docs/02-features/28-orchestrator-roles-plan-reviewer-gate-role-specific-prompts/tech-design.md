# Technical Design: Orchestrator roles + Plan Reviewer gate + role-specific prompts
...
- Implement `Orchestrator roles + Plan Reviewer gate + role-specific prompts` in line with PRD priority `P1`.
...
- Feature artifacts: `docs/02-features/28-orchestrator-roles-plan-reviewer-gate-role-specific-prompts`
