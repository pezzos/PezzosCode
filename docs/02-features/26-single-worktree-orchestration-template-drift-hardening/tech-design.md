# Technical Design: Single-worktree orchestration + template-drift hardening
...
- Implement `Single-worktree orchestration + template-drift hardening` in line with PRD priority `P0`.
...
- Feature artifacts: `docs/02-features/26-single-worktree-orchestration-template-drift-hardening`
