...
- In scope: Update scripts or templates to enforce the specified workflow
- Out of scope: Unrelated tooling changes outside the ticket workflow
...
- Review workflow spec in feature docs
- Update tools/scripts to enforce the workflow
- Verify tests and CI gates

## Evidence Hints

- TODO: Add 1-2 objective hints after implementation (file + anchor checks)
...
- Expected changes: Update scripts or templates to enforce behavior
- Key decisions: TBD
- Trade-offs: TBD
